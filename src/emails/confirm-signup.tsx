...
export function ConfirmSignupEmail({ confirmLink = "{{ .ConfirmationURL }}" }: { confirmLink?: string }) {
  return (
    <Html>
      <Head />
      <Preview>Confirm your BookletFlow email address</Preview>
      <Body style={body}>
        <Container style={container}>
          ...
          <Section style={card}>
            ...
            <Text style={paragraph}>
              Thanks for signing up for BookletFlow. Click the button below to verify your email address and activate your account.
            </Text>
            ...
            <Text style={hint}>
              This link expires in 24 hours. If you didn&apos;t create a BookletFlow account, you can safely ignore this email.
            </Text>
